...
{
    public partial class ClientEventConfirmBookingForm : Form
    {
        ...
        public ClientEventConfirmBookingForm(string username, int agencyId, string packageName, string serviceArea, decimal pricePerHead)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (paymentForm.ShowDialog() == DialogResult.OK)
            {
                ...
                button2_Click(username, agencyId, guests, eventDate, totalPrice, paymentMethod);
            }
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    string bookingQuery = @"INSERT INTO Bookings
                             ...
                             VALUES
                             (@ClientUserName, @ServiceProviderId, 'Event Agency', @BookingDate, @NoOfPersons, @TotalAmount, 'Requested');
