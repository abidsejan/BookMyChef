...
{
    public partial class ClientConfirmBookingForm : Form
    {
        string username;
        int chefId;
        string chefName;
        ...
        public ClientConfirmBookingForm(
            string username,
            int chefId,
            string chefName,
            string serviceArea,
        ...
        private void SaveBookingAndPayment(string clientUser, int serviceProviderId, int noOfPersons, DateTime bookingDate, decimal totalAmount, string paymentMethod)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    string bookingQuery = @"INSERT INTO Bookings
                             ...
                             VALUES
                             (@ClientUserName, @ServiceProviderId, 'Private Chef', @BookingDate, @NoOfPersons, @TotalAmount, 'Requested');
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            decimal totalPrice = guests * pricePerHead;
            this.Hide();
            ...
            if (paymentForm.ShowDialog() == DialogResult.OK)
            {
                ...
                SaveBookingAndPayment(username, chefId, guests, eventDate, totalPrice, paymentMethod);
            }
        }
    }
}